...
export default function ProductCard({ img, text, price, salePrice, salePercent, rating, pageType }) {
  const retailPriceClass = pageType === 'sale-page' ? 'retail-price-sale' : 'retail-price-guest';
